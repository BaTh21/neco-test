...
from app.schemas.note import NoteCreate, NoteUpdate, NoteOut, ShareNoteRequest, UserResponse
from app.crud.note import (
    ...
    share_note, get_shared_notes, stop_sharing,
